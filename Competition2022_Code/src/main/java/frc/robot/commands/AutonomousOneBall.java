...
public class AutonomousOneBall extends SequentialCommandGroup{
    public AutonomousOneBall(){
        ...
        new InstantCommand(() -> RobotContainer.m_chassis.convertSwerveValues(0.0, 0.5, 0.0)),
        ...
        new InstantCommand(() -> RobotContainer.m_chassis.stopChassis()),
        ...
        new InstantCommand(() -> RobotContainer.m_launcher.setPreset(0.0, 0.0)).alongWith(new InstantCommand(() -> RobotContainer.m_launcher.setIndexSpeed(0.0))).alongWith
